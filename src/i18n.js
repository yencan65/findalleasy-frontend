  ...
  tr: {
    translation: {
      ...
      ai: {
        ...
        hello: "Merhaba, ben Sono. Ürün/hizmet arayabilir veya herhangi bir konuda soru sorup bilgi alabilirsin.",
  ...
  en: {
    translation: {
      ...
      ai: {
        ...
        hello: "Hi, I'm Sono. Search for a product/service or ask me any question for quick info.",
  ...
  fr: {
    translation: {
      ...
      ai: {
        ...
        analyzing: "Analyse…",
        hello: "Bonjour, je suis Sono. Cherche un produit/service ou pose-moi une question pour une info rapide.",
  ...
  ru: {
    translation: {
      ...
      ai: {
        ...
        analyzing: "Анализ…",
        hello: "Привет, я Sono. Ищи товары/услуги или задавай любые вопросы — помогу с информацией.",
  ...
  ar: {
    translation: {
      ...
      ai: {
        ...
        hello: "مرحباً، أنا Sono. ابحث عن منتج/خدمة أو اسألني أي سؤال للحصول على معلومات سريعة.",
