  ...
  return (
    <header
      className="
        ...
        px-3 sm:px-6 py-3 sm:py-4 bg-[rgba(16,18,14,0.72)]
        border-b border-[#d4af37]/18
      ...
      <div className="flex flex-nowrap items-center justify-end gap-2 sm:gap-4 flex-shrink-0">
        ...
        <div className="relative" ref={langRef}>
          <button
            ...
            className="
              ...
              bg-[rgba(16,18,14,0.72)]/25 backdrop-blur-lg
          ...
          {openLang && (
            <div
              className="
                ...
                bg-[rgba(16,18,14,0.72)]/45 backdrop-blur-2xl
        ...
        <button
          ...
          className="
            ...
            text-[#d4af37] bg-[rgba(16,18,14,0.72)]/20 backdrop-blur-lg
            hover:bg-[#d4af37]/20 hover:text-black
            transition-all
          "
        >
        ...
        <div className="relative" id="user-menu">
          <button
            ...
            className="
              ...
              bg-[rgba(16,18,14,0.72)]/20 backdrop-blur-lg
              hover:bg-[#d4af37]/20 hover:text-black
              transition-all
            "
          >
          ...
          {userOpen && (
            <div
              className="
                ...
                bg-[rgba(16,18,14,0.72)]/75 backdrop-blur-xl
