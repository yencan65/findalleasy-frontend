  ...
  return (
    <header
      className="
        ...
        px-3 sm:px-6 py-3 sm:py-4 bg-[#0f110d]/88
      ...
      <div className="flex flex-nowrap items-center justify-end gap-2 sm:gap-4 flex-shrink-0">
          ...
          {openLang && (
            <div
              className="
                ...
                bg-[#0f110d]/45 backdrop-blur-2xl
        ...
        <button
          ...
          className="
            ...
            text-[#d4af37] bg-[#0f110d]/20 backdrop-blur-lg
            hover:bg-[#d4af37]/20 hover:text-black
            transition-all
          "
        >
